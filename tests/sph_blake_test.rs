...
#[test]
fn will_be_224_hash() {
    let dest   = sph_blake::blake224_init_load_close("");
...
#[test]
fn will_be_256_hash() {
    let dest   = sph_blake::blake256_init_load_close("");
    let actual = utils::to_hex_hash(&dest);
...
#[test]
fn will_be_384_hash() {
    let dest   = sph_blake::blake384_init_load_close("");
    let actual = utils::to_hex_hash(&dest);
...
#[test]
fn will_be_512_hash() {
    let dest   = sph_blake::blake512_init_load_close("");
    let actual = utils::to_hex_hash(&dest);
